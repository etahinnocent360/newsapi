...
var routes = [
    { path: '', component: topnews_component_1.TopnewsComponent },
    { path: 'technews', component: technews_component_1.TechnewsComponent },
    { path: 'businessnews', component: businessnews_component_1.BusinessnewsComponent },
];
